...
allowed-tools: sandbox_run_command(agent-browser:*)
---

# agent-browser core

**CRITICAL SANDBOX INSTRUCTION:** All `agent-browser` commands MUST be executed within the isolated sandbox environment using the `sandbox_run_command` tool. Do NOT use the local machine shell (Bash).
