...
async def _start_gmail() -> None:
    ...
    try:
        ...
        logger.exception("Gmail configuration is invalid; connector disabled")
        return
    if config is None:
...
async def _stop_gmail() -> None:
    ...
    if _gmail_oauth_service is not None:
        try:
            ...
            logger.exception("Error closing Gmail connector")
...
async def gmail_callback(
    ...
    from .gmail import GmailApiError, GmailOAuthError
